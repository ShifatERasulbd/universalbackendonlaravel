...
@section('title', 'Edit Menu - NexusAdmin')
...
<div style="max-width:700px;">
    <div style="display:flex; align-items:center; gap:0.75rem; margin-bottom:2rem;">
        ...
        <div>
            <h2 style="font-size:1.5rem; font-weight:600; color:var(--text-primary); margin:0;">Edit Menu</h2>
            <p style="font-size:0.875rem; color:var(--text-secondary); margin-top:0.25rem;">Update menu: <strong>{{ $menu->title }}</strong></p>
        </div>
    </div>
    ...
    <form action="{{ route('menus.update', $menu) }}" method="POST">
        ...
        <div class="card" style="border-radius:12px; background:var(--card-bg); border:1px solid var(--border-color); padding:2rem; margin-bottom:1.5rem;">
            ...
            <div style="margin-bottom:1.75rem;">
                ...
                <input type="text" name="title" value="{{ old('title', $menu->title) }}" placeholder="e.g. Home, About, Contact" 
            ...
            <div style="margin-bottom:1.75rem;">
                ...
                <input type="text" name="url" value="{{ old('url', $menu->url) }}" placeholder="e.g. /about-us or https://example.com" 
            ...
            <div style="margin-bottom:1.75rem;">
                ...
                <div style="display:flex; gap:0.75rem;">
                    <input type="text" name="icon" value="{{ old('icon', $menu->icon) }}" placeholder="e.g. home, dashboard, settings" 
        ...
        <div style="display:flex; gap:0.75rem;">
            <button type="submit" class="btn btn-primary" style="display:inline-flex; align-items:center; gap:0.4rem; padding:0.65rem 1.5rem; font-weight:600;">
                <span class="material-icons-round" style="font-size:1.2rem;">save</span> Update Menu
            </button>
