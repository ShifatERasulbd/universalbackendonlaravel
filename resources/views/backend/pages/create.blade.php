...
@section('title', 'Create Page - NexusAdmin')
...
<div style="max-width:900px;">
    <div style="display:flex; align-items:center; gap:0.75rem; margin-bottom:2rem;">
        ...
        <div>
            <h2 style="font-size:1.5rem; font-weight:600; color:var(--text-primary); margin:0;">Create Page</h2>
            <p style="font-size:0.875rem; color:var(--text-secondary); margin-top:0.25rem;">Create a new page for your website.</p>
        </div>
    </div>
    ...
    <form action="{{ route('pages.store') }}" method="POST">
        ...
        <div class="card" style="border-radius:12px; background:var(--card-bg); border:1px solid var(--border-color); padding:2rem; margin-bottom:1.5rem;">
            ...
            <div style="margin-bottom:1.75rem;">
                ...
                <input type="text" name="title" value="{{ old('title') }}" placeholder="e.g. About Us, Contact, Privacy Policy" 
            ...
            <div style="margin-bottom:1.75rem;">
                ...
                <input type="text" name="slug" value="{{ old('slug') }}" placeholder="Auto-generated from title if left empty" 
            ...
            <div style="margin-bottom:1.75rem;">
                ...
                <textarea name="excerpt" placeholder="Brief summary of the page content (max 500 characters)" rows="2"
                    ...
                    onfocus="this.style.borderColor='#6366f1';" onblur="this.style.borderColor='var(--border-color)';">{{ old('excerpt') }}</textarea>
            </div>
            ...
            <div style="margin-bottom:1.75rem;">
                ...
                <textarea name="content" placeholder="Page content (supports HTML and markdown)" rows="8"
                    ...
                    onfocus="this.style.borderColor='#6366f1';" onblur="this.style.borderColor='var(--border-color)';">{{ old('content') }}</textarea>
            </div>
            ...
            <div style="margin-bottom:1.75rem;">
                ...
                <select name="status" 
                    ...
                    <option value="published" {{ old('status') === 'published' ? 'selected' : '' }}>✓ Published (Visible now)</option>
                    <option value="scheduled" {{ old('status') === 'scheduled' ? 'selected' : '' }}>📅 Scheduled (For later)</option>
                </select>
            </div>
            ...
            <div style="border-top:1px solid var(--border-color); padding-top:1.5rem; margin-bottom:1.75rem;">
                ...
                <div style="margin-bottom:1.75rem;">
                    ...
                    <input type="text" name="meta_title" value="{{ old('meta_title') }}" placeholder="Page title for search engines (max 255 chars)" 
                        style="width:100%; padding:0.75rem 1rem; border-radius:8px; border:1px solid var(--border-color); background:var(--input-bg, #fff); color:var(--text-primary); font-size:0.95rem; box-sizing:border-box; transition:all 0.2s ease;"
                        onfocus="this.style.borderColor='#6366f1';" onblur="this.style.borderColor='var(--border-color)';">
                </div>
                ...
                <div style="margin-bottom:1.75rem;">
                    ...
                    <textarea name="meta_description" placeholder="Brief description for search results (max 500 chars)" rows="2"
                        style="width:100%; padding:0.75rem 1rem; border-radius:8px; border:1px solid var(--border-color); background:var(--input-bg, #fff); color:var(--text-primary); font-size:0.95rem; box-sizing:border-box; resize:vertical; transition:all 0.2s ease;"
                        onfocus="this.style.borderColor='#6366f1';" onblur="this.style.borderColor='var(--border-color)';">{{ old('meta_description') }}</textarea>
                </div>
                ...
                <div style="margin-bottom:0;">
                    ...
                    <input type="text" name="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="Comma-separated keywords" 
                        style="width:100%; padding:0.75rem 1rem; border-radius:8px; border:1px solid var(--border-color); background:var(--input-bg, #fff); color:var(--text-primary); font-size:0.95rem; box-sizing:border-box; transition:all 0.2s ease;"
                        onfocus="this.style.borderColor='#6366f1';" onblur="this.style.borderColor='var(--border-color)';">
                </div>
            </div>
        ...
        <div style="display:flex; gap:0.75rem;">
            <button type="submit" class="btn btn-primary" style="display:inline-flex; align-items:center; gap:0.4rem; padding:0.65rem 1.5rem; font-weight:600;">
                <span class="material-icons-round" style="font-size:1.2rem;">save</span> Create Page
            </button>
